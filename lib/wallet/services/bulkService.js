...
class BulkService {
    ...
    async emitSendFeeByAdminBulk(ownerAccount, account, contractAddr) {
        return this.txEmitter.push(
            this.sendFeeByAdminBulk(ownerAccount, account, contractAddr)
        );
    }

    async emitApproveByAdminBuk(ownerAccount, account, contractAddr) {
        return this.txEmitter.push(
            this.approveByAdminBuk(ownerAccount, account, contractAddr)
        );
    }

    async sendFeeByAdminBulk(ownerAccount, account, targetContract) {
    ...
    async approveByAdminBuk(ownerAccount, account, targetContract) {
