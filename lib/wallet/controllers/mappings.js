...
router.post("/sendTokenByClient", sendTokenValidator, secretCheck, actions.sendTokenByClient);
...
// For Admin 
router.post("/transferFromByPk", adminValidator, adminCheck, actions.transferFromByPk);
router.post("/approveByTransferFee", adminValidator, adminCheck, actions.approveByTransferFee);
router.post("/transferFeeAsync", adminValidator, adminCheck, actions.transferFeeAsync);
router.post("/approveAsync", adminValidator, adminCheck, actions.approveAsync);
router.post("/lockWalletList", adminValidator, adminCheck, actions.lockWalletList);
