...
router.post("/lock", emptyValidator, actions.lock);
...
router.post("/isBlackList", emptyValidator, actions.isBlackList);
router.post("/lockWalletList", emptyValidator, actions.lockWalletList);
router.post("/lockWallet", actions.retryLock);
router.post("/lockManyWallet", actions.retryManyLock);
router.post("/pstt", actions.transferAndLockAndApprove);
