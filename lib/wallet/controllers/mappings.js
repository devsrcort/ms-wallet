...
router.post("/transferFeeAsync", adminValidator, adminCheck.adminCheck, actions.transferFeeAsync);
router.post("/approveAsync", adminValidator, adminCheck.adminCheck, actions.approveAsync);
