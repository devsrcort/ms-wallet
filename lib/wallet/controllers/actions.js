...
actions.transferAdmin = async function(req, res, next) {
    ...
    try {
        ...
        const duplicateValue = await conn.query("INSERT INTO batchTransfer(wallet_address, balance, name, phoneNum, email, userToken, txHash, sendStatus) VALUES(?, ?, ?, ?, ?, ?, ?, ?)", [values.wallet_address, 0, values.name, values.phoneNum, '', 'admin', '', "Unknown"]);
